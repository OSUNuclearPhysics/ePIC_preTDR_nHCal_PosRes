...
*/
	...
	gSystem->cd(mkdir);
	TFile *fileOut = new TFile("outputEnePos.root", "recreate");
	fileOut->cd();
	gSystem->cd("../");
	...
	names->push_back("h_MCpart_Pion_p_E");
	//names->push_back("h_MCpart_Pion_n_E");
	names->push_back("h_MCpart_Kaon_p_E");
	//names->push_back("h_MCpart_Kaon_n_E");
	names->push_back("h_MCpart_Proton_p_E");
	//names->push_back("h_MCpart_Proton_n_E");
	names->push_back("h_MCpart_Electron_p_E");
	//names->push_back("h_MCpart_Electron_n_E");
	names->push_back("h_MCpart_Neutron_E");
	names->push_back("h_MCpart_Gamma_E");
	...
	vec_cnv->at(0)->cd(1)->SaveAs(Form("%s.png", "h_MCpart_pos_E"));
