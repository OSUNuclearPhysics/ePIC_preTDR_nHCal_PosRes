...
int readEventsFrameReco(TString list = "data/filesReco_SimCampaign.list", TString ofname = "output/output_test.root", long nevents = -1)
{
...
int MakeEvent(podio::Frame *frame, unsigned ev)
{
	...
	auto& nHCal_hits_frame  = frame->get<edm4eic::CalorimeterHitCollection>("HcalEndcapNRecHits");
