...
edm4eic::Cluster GetCaloCluster(edm4eic::ClusterData cluData);
...
edm4eic::Cluster GetCaloCluster(edm4eic::ClusterData cluData)
{
	edm4eic::Cluster cluster(cluData.type, cluData.energy, cluData.energyError, cluData.time, cluData.timeError, cluData.nhits, cluData.position, cluData.positionError, cluData.intrinsicTheta, cluData.intrinsicPhi, cluData.intrinsicDirectionError);
